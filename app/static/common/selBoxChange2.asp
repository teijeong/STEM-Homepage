...
IF catecode<>"" Then
    Sql="Select lowcode,name From Category Where middlecode="&catecode&" AND lowcode<>middlecode Order By align1Num ASC,align2Num ASC,align3Num ASC"
...
IF IsArray(Allrec) Then
    Response.Write "document.getElementById('selBox3').style.display='inline';"&Vbcrlf
    For i=0 To Ubound(Allrec,2)
        Response.write "document.getElementById('selBox3').options.add(new Option('"&Allrec(1,i)&"','"&Allrec(0,i)&"'));"
    Next
    ...
    End IF
Else
    Response.Write "document.getElementById('selBox3').style.display='none';"&Vbcrlf
End IF
