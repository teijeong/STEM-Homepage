...
<div style="margin:0px; background:url('/library/popSkin/pop6.jpg') left top no-repeat; width:400px; height:500px;">
<div style="padding:20px 0px 0 60px;">
    <div id='HKeditorContent' name='HKeditorContent' style="position:relative; width:330px; height:470px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>