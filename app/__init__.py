...
ALLOWED_EXTENSIONS_DOCUMENT = set('doc_docx_ppt_pptx_xls_xlsx_hwp_txt'.split('_'))
ALLOWED_EXTENSIONS_IMAGE = set('jpg_png_gif_bmp'.split('_'))
ALLOWED_EXTENSIONS_ARCHIVE = set('zip_7z_alz_gz_gzip'.split('_'))
ALLOWED_EXTENSIONS_MEDIA = set('avi_wmv_mkv_mp4_mp3_wma_wav_ogg'.split('_'))
ALLOWED_EXTENSIONS_CODE= set('c_cpp_h_hpp_py_rb_md_rkt_ml'.split('_'))
...
app.config['UPLOAD_FOLDER'] = os.path.join(app.config['APP_ROOT'], 'static/upload')
