...
<div style="margin:0px; background:url('/library/popSkin/pop3.jpg') left top no-repeat; width:350px; height:455px;">
<div style="padding:130px 10px 0;">
	<div id='HKeditorContent' name='HKeditorContent' style="position:relative;  width:330px; height:240px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>