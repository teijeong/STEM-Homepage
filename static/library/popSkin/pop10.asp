...
<div style="margin:0px; background:url('/library/popSkin/pop10.jpg') left top no-repeat; width:400px; height:456px;">
<div style="padding:70px 0px 0 50px;">
	<div id='HKeditorContent' name='HKeditorContent' style="position:relative; width:310px; height:210px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>
