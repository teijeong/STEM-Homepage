...
<div style="margin:0px; background:url('/library/popSkin/pop7.jpg') left top no-repeat; width:400px; height:500px;">
<div style='padding:180px 0px 0 10px;'>
	<div id='HKeditorContent' name='HKeditorContent' style="position:relative; width:350px; height:300px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>