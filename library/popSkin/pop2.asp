...
<div style="margin:0px; background:url('/library/popSkin/pop2.jpg') left top no-repeat; width:350px; height:400px;">
<div style="padding:130px 40px 0;">
	<div id='HKeditorContent' name='HKeditorContent' style="position:relative;  width:260px; height:190px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>