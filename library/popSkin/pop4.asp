...
<div style="margin:0px; background:url('/library/popSkin/pop4.jpg') left top no-repeat; width:600px; height:485px;">
<div style="padding:100px 140px 0;">
	<div id='HKeditorContent' name='HKeditorContent' style="position:relative;  width:380px; height:280px; word-wrap:break-all; overflow:auto;"><%=Content%></div>
</div>
</div>
</html>