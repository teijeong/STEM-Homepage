...
Sql="select top "&PageSize&" idx,writer,tel,phone,submit,regdate,sosok,email from consult1 WHERE 1=1 "&StrWhere&" AND idx NOT IN (select top "&(Page-1)*PageSize&" idx from consult1 Where 1=1 "&StrWhere&" order by Idx DESC) order by Idx DESC"
Rs.Open Sql,DBcon,1
