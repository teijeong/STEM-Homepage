...
tmpDB = "select WW from ViewCounter where Register >= Convert(DateTime, '" & FDATE & " 00:00:00') and Register <= Convert(DateTime, '" & EDATE & " 23:59:59')"
...
For C = 1 to 7
    sql = "select Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB where WW = '" & C & "'"
    GetRs Rs, sql
