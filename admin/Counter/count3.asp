...
tmpDB = "select LTrim(RTrim(Window)) as window from ViewCounter where Register >= Convert(DateTime, '" & FDATE & " 00:00:00') and Register <= Convert(DateTime, '" & EDATE & " 23:59:59')"
...
sql = "select Window, Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB GROUP BY Window ORDER BY TotalVisit DESC"
GetRs Rs, sql
if rs.eof then
%>
       <tr>
         <td colspan="4" height="30" align="center" bgcolor="#FFFFFF">등록된 접속자가 없습니다.</td>    
       </tr>
<%
else
Do While Not Rs.Eof
    ...
    select case Window
        case "Windows NT 5.0" : Window = "Windows 2000"
        case "Windows NT 5.1" : Window = "Windows XP"
        case "Windows NT 5.2" : Window = "Windows 2003"
    end select
%>
