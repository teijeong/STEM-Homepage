...
tmpDB = "select Browser from ViewCounter where Register >= Convert(DateTime, '" & FDATE & " 00:00:00') and Register <= Convert(DateTime, '" & EDATE & " 23:59:59')"
...
sql = "select Browser, Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB GROUP BY Browser ORDER BY TotalVisit DESC"
GetRs Rs, Sql
if rs.eof then
%>
	   <tr>
...
Do While Not Rs.Eof
	...
	select case Browser
		case "MSIE 6.0" : Browser = "MSIE 6.0"
		case "MSIE 5.01" : Browser = "MSIE 5.01"
	end select
%>
