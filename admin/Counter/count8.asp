...
tmpDB = "select YY from ViewCounter where Register >= Convert(DateTime, '" & FDATE & " 00:00:00') and Register <= Convert(DateTime, '" & EDATE & " 23:59:59')"
...
'    NDATE = DateAdd("d", C, FDATE)
    sql = "select YY, Count(*) AS TotalVisit from (" & tmpDB & ") tmpDB Group By YY"
    GetRs Rs, sql
    Do While Not Rs.eof
        NDATE = rs("YY") & "년"
